...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_review', (
            ...
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 15, 0, 0))),
        ))
        ...
        db.create_table(u'app_property', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('upstream_id', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('yelp_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
            ('yelp_scraped', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('yelp_processing', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
